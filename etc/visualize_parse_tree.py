#!/usr/bin/env python3
"""Script to visualize parse trees generated by `tree-sitter-gaptst`

Make sure to run `python3 -m pip install .` in the project root to install the
python bindings for the development version of the `tree-sitter-gaptst` grammar.
"""

import argparse
import tree_sitter_gaptst as tsgaptst
...
if __name__ == "__main__":
    ...
    GAPTST_LANGUAGE = Language(tsgaptst.language())
    parser = Parser(GAPTST_LANGUAGE)
